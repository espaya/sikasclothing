                ...
                <nav class="navbar navbar-light">
                    <div class="navbar-left">
                        <a href="" class="sidebar-toggle">
                            <img class="svg" src="img/svg/bars.svg" alt="img"></img>
                        </a>
                        <a class="navbar-brand" href="#">
                            <img class="dark" src="img/logo_dark.png" alt="svg"></img>
                            <img class="light" src="img/logo_white.png" alt="img"></img>
                        </a>
                        <form action="/" class="search-form">
                            <span data-feather="search"></span>
                            <input class="form-control mr-sm-2 box-shadow-none" type="text" placeholder="Search..."></input>
                        </form>
                        <div class="top-menu">
                                ...
                                <ul>
                                    <li class="has-subMenu">
                                        ...
                                        <ul class="subMenu">
                                            ...
                                            <li>
                                                <a class="" href="business.html">
                                                    FineTech / Business
                                                </a>
                                            </li>
                                            <li>
                                                <a class="" href="performance.html">
                                                    Site Performance
                                                </a>
                                            </li>
                                            <li>
                                                <a class="active" href="ecommerce.html">
                                                    Ecommerce
                                                </a>
                                            </li>
                                            <li>
                        ...
                        <ul class="navbar-right__menu">
                                ...
                                <div class="dropdown-custom">
                                    ...
                                    <div class="dropdown-wrapper">
                                        <h2 class="dropdown-wrapper__title">
                                            Messages <span class="badge-circle badge-success ml-1">2</span>
                                        </h2>
                                        <ul>
                            ...
                            <li class="nav-notification">
                                <div class="dropdown-custom">
                                    ...
                                    <div class="dropdown-wrapper">
                                        <h2 class="dropdown-wrapper__title">
                                            Notifications <span class="badge-circle badge-warning ml-1">4</span>
                                        </h2>
                                        <ul>
                                ...
                                <div class="dropdown-custom">
                                    ...
                                    <div class="dropdown-wrapper dropdown-wrapper--large">
                                        <ul class="list-settings">
                                            ...
                                            <li class="d-flex">
                                                <div class="mr-3">
                                                    <img src="img/color-palette.png" alt=""></img>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6>
                                                        <a href="" class="stretched-link">
                                            ...
                                            <li class="d-flex">
                                                <div class="mr-3">
                                                    <img src="img/video-camera.png" alt=""></img>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6>
                                                        <a href="" class="stretched-link">
                                            ...
                                            <li class="d-flex">
                                                <div class="mr-3">
                                                    <img src="img/document.png" alt=""></img>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6>
                                                        <a href="" class="stretched-link">
                                            ...
                                            <li class="d-flex">
                                                <div class="mr-3">
                                                    <img src="img/microphone.png" alt=""></img>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <h6>
                                                        <a href="" class="stretched-link">
                            ...
                            <li class="nav-flag-select">
                                <div class="dropdown-custom">
                                    <a href="javascript:;" class="nav-item-toggle">
                                        <img src="img/flag.png" alt="" class="rounded-circle"></img>
                                    </a>
                                    <div class="dropdown-wrapper dropdown-wrapper--small">
                                        <a href="">
                                            <img src="img/eng.png" alt=""></img> English
                                        </a>
                                        <a href="">
                                            <img src="img/ger.png" alt=""></img> German
                                        </a>
                                        <a href="">
                                            <img src="img/spa.png" alt=""></img> Spanish
                                        </a>
                                        <a href="">
                                            <img src="img/tur.png" alt=""></img> Turkish
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="nav-author">
                                <div class="dropdown-custom">
                                    <a href="javascript:;" class="nav-item-toggle">
                                        <img src="img/author-nav.jpg" alt="" class="rounded-circle"></img>
                                    </a>
                                    <div class="dropdown-wrapper">
