                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="profile-setting.html" class="">
                                        Profile Settings<span class="badge badge-success menuItem">New</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="user-info.html" class="">
                                        <span class="badge badge-success menuItem">New</span>Add User
                                    </a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="bookmarks.html" class="">
                                ...
                                <span class="menu-text">
                                    Bookmarks<span class="badge badge-success menuItem">New</span>
                                </span>
                            </a>
                        </li>
                        <li class="menu-title m-top-30">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a class="" href="grid.html">
                                        <span class="badge badge-success menuItem">New</span>Grid
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="gallery2.html" class="">
                                        Gallery 2<span class="badge badge-success menuItem">New</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
