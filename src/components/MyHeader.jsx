...
export default function MyHeader() {
    ...
    useEffect(() => {
        ...
        document.querySelectorAll('.js-close-aside').forEach((btn) => btn.addEventListener('click', closeAside));
        ...
        return () => {
            ...
            document.querySelectorAll('.js-close-aside').forEach((btn) => btn.removeEventListener('click', closeAside));
        ...
        <header id="header" className="header header-fullwidth header-transparent-bg">
            ...
            <div className="header-top d-flex color-white align-items-center bg-black">
                ...
                <ul className="list-unstyled d-flex m-0 flex-1 gap-3">
                    {topLinks.map((link, index) => (
                        <li key={index}>
                            <a href={link.href} className="menu-link menu-link_us-s color-white">
                                {link.text}
                            </a>
                        </li>
                    ))}
                ...
                <div className="heeader-top__right d-flex justify-content-end flex-1 gap-1">
                        ...
                        {socialLinks.map((social, index) => (
                            <li key={index}>
                                <a href="#" className="footer__social-link d-block color-white">
                                    <svg
                                        className={`svg-icon svg-icon_${social.icon.replace('icon_', '')}`}
                                        width={social.width}
                    ...
                    {/* Language Selector */}
                    <select className="form-select form-select-sm color-white bg-transparent" name="store-language">
                        {languages.map((lang) => (
                    ...
                    {/* Currency Selector */}
                    <select className="form-select form-select-sm color-white bg-transparent" name="store-currency">
                        {currencies.map((curr) => (
            ...
            <div className="header-desk header-desk_type_2">
                <nav className="navigation d-flex">
                    <a className="navigation__item" href="#" data-bs-toggle="modal" data-bs-target="#siteMap">
                ...
                <div className="header-tools d-flex align-items-center">
                    ...
                    <div className="header-tools__item hover-container">
                        ...
                        {isSearchOpen && (
                            ...
                            >
                                <form action="./search_result.html" method="GET" className="search-field container">
                                    <p className="text-uppercase fw-medium mb-4 text-secondary" style={{ fontSize: '14px', color: '#666' }}>
                                    ...
                                    <div className="search-popup__results mt-4">
                                        <div className="sub-menu search-suggestion">
                                            <h6
                                                ...
                                                style={{ fontSize: '14px', textTransform: 'uppercase', color: '#666' }}
                                            >
                                                QUICKLINKS
                                            </h6>
                    ...
                    <a href="#" className="header-tools__item header-tools__cart js-open-aside" data-aside="cartDrawer">
                        ...
                        <span className="cart-amount d-block position-absolute js-cart-items-count">4</span>
                    </a>
                </div>
            </div>
        </header>
